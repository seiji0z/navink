  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-md">
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6">
        <button className="w-full sm:w-auto px-5 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
          Cancel
        </button>
        <button className="w-full sm:w-auto px-5 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-sm font-medium transition shadow-sm">
          Save Defaults
        </button>
      </div>
    </div>
